...
const steps = [
  ...
  {id: 8, component: SetupScanStep, titleKey: 'setup.steps.scan.title', required: false},
  {id: 9, component: SetupThankwordsStep, titleKey: 'setup.steps.thankwords.title', required: false},
