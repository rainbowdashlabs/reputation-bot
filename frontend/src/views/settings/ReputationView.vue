...
<template>
  <SettingsContainer :description="t('general.reputation.description')" :title="t('settings.reputation')">
    <div class="space-y-8">
      <ReputationModeSettings/>
      <template v-if="session?.settings?.general?.reputationMode === ReputationMode.TOTAL">
