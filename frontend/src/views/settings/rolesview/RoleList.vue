...
<template>
  <div class="space-y-4">
    <div class="flex flex-col gap-1">
      <label class="block text-sm font-medium text-gray-900 dark:text-gray-100">{{ t('general.roles.list.label') }}</label>
      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ t('general.roles.list.description') }}</p>
    </div>

    <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden divide-y divide-gray-200 dark:divide-gray-700 max-h-96 overflow-y-auto">
      <div 
