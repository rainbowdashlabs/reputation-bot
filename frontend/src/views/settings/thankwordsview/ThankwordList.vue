...
<template>
  <div v-if="words.length > 0"
       class="flex flex-wrap gap-1.5 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
    <div
        v-for="word in words"
        :key="word"
  ...
  <div v-else
       class="p-8 text-center text-gray-500 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 italic">
    {{ t('thankwords.none') }}
  </div>
</template>
