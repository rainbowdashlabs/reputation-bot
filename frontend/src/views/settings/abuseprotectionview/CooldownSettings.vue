    ...
    <template v-else>
      ...
      <div class="flex flex-col gap-2">
        ...
        <select v-model="cooldownDirection" class="select">
          <option :value="CooldownDirection.UNIDIRECTIONAL">{{
              t('abuseProtection.cooldownDirection.unidirectional')
            }}
          </option>
          <option :value="CooldownDirection.BIDIRECTIONAL">{{
              t('abuseProtection.cooldownDirection.bidirectional')
            }}
          </option>
        </select>
