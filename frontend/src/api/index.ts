...
class ApiClient {
    ...
    public async updateProfilePicture(profilePicture: Blob | File): Promise<string> {
        const response = await this.axiosInstance.post<string>('/settings/profile/picture', profilePicture, {
