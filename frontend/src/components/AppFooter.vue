...
<template>
  <footer
    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
        <div class="order-3 md:order-1"></div>
        ...
        <div class="flex items-center justify-center md:justify-end gap-3 order-2 md:order-3">
          <GuildSwitcher/>
        </div>
      </div>
    </div>
