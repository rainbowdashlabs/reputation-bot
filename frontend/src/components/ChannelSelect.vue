...
const selectedChannel = computed(() => {
  ...
  return allChannels.find(c => c.id === stringId) || null
})
          ...
          <div class="overflow-y-auto custom-scrollbar bg-white dark:bg-gray-800">
            ...
            >
              <div class="pl-2">
                ...
                <span class="truncate">{{ channel.name }} ({{ channel.id }})</span>
              </div>
            </BaseButton>
            ...
            <div v-for="category in filteredCategories" :key="category.id">
              <div
                  class="px-3 py-1.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider bg-gray-50/80 dark:bg-gray-700/50 border-y border-gray-100 dark:border-gray-700/50">
                {{ category.name }}
              </div>
              <BaseButton
            ...
            <div v-if="filteredUncategorized.length === 0 && filteredCategories.length === 0"
