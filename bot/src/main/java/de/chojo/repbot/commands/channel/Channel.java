    ...
    public Channel(GuildRepository guildRepository, Configuration configuration, AutopostService autopostService) {
        super(Slash.of("channel", "command.channel.description")
                ...
                .subCommand(sub("set", "command.channel.set.description")
                        ...
                        .argument(channel("channel", "command.channel.set.options.channel.description")
                                .asRequired()))
                .subCommand(sub("add", "command.channel.add.description")
                        .handler(new Add(guildRepository, configuration))
                        .argument(channel("channel", "command.channel.add.options.channel.description")
                                .asRequired()))
                ...
                .subCommand(sub("listtype", "command.channel.listtype.description")
                        ...
                        .argument(text("type", "command.channel.listtype.options.type.description")
                                .asRequired()
                                .withAutoComplete()))
                .subCommand(sub("list", "command.channel.list.description").handler(new List(guildRepository)))
                .group(group("announcement", "command.channel.announcement.description")
                        .subCommand(sub("state", "command.channel.announcement.state.description")
                                ...
                                .argument(
                                        bool("active", "command.channel.announcement.state.options.active.description")
                                                .asRequired()))
                        .subCommand(sub("where", "command.channel.announcement.where.description")
                                .handler(new AnnouncementWhere(guildRepository))
                                .argument(text("where", "command.channel.announcement.where.options.where.description")
                                        .asRequired()
                                        .withAutoComplete()))
                        .subCommand(sub("channel", "command.channel.announcement.channel.description")
                                ...
                                .argument(channel(
                                                "channel",
                                                "command.channel.announcement.channel.options.channel.description")
                                        .asRequired()))
                ...
                .group(group("autopost", "command.channel.autopost.description")
                        .subCommand(sub("enable", "command.channel.autopost.enable.description")
                                ...
                                .argument(channel(
                                                "channel",
                                                "command.channel.autopost.enable.options.channel.description")
                                        .asRequired())
                                .argument(text(
                                                "refreshtype",
                                                "command.channel.autopost.enable.options.refreshtype.description")
                                        .withAutoComplete())
                                .argument(text(
                                                "refreshinterval",
                                                "command.channel.autopost.enable.options.refreshinterval.description")
                                        .withAutoComplete()))
                ...
                .group(group("log", "command.channel.log.description")
                        .subCommand(sub("enable", "command.channel.log.enable.description")
                                ...
                                .argument(channel("channel", "command.channel.log.enable.options.channel.description")
                                        .asRequired()))
                ...
                .group(group("systemchannel", "command.channel.systemchannel.description")
                        .subCommand(sub("enable", "command.channel.systemchannel.enable.description")
                                ...
                                .argument(channel(
                                                "channel",
                                                "command.channel.systemchannel.enable.options.channel.description")
                                        .asRequired()))
