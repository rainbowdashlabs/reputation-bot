...
import de.chojo.repbot.commands.abuseprotection.handler.cooldown.GetCooldown;
import de.chojo.repbot.commands.abuseprotection.handler.cooldown.OnceCooldown;
import de.chojo.repbot.commands.abuseprotection.handler.cooldown.SetCooldown;
import de.chojo.repbot.commands.abuseprotection.handler.cooldown.SetCooldownDirection;
        ...
        super(Slash.of("abuseprotection", "command.abuseprotection.description")
                ...
                .group(Group.of("message", "command.abuseprotection.message.description")
                        .subCommand(SubCommand.of("age", "command.abuseprotection.message.age.description")
                                ...
                                .argument(Argument.integer(
                                                "minutes",
                                                "command.abuseprotection.message.age.options.minutes.description")
                                        .min(0)
                                        .max(ChronoUnit.WEEKS.getDuration().toMinutes())))
                        .subCommand(
                                SubCommand.of("reputation", "command.abuseprotection.message.reputation.description")
                        ...
                        .subCommand(SubCommand.of("min", "command.abuseprotection.message.min.description")
                                ...
                                .argument(Argument.integer(
                                                "messages",
                                                "command.abuseprotection.message.min.options.messages.description")
                                        .min(0)
                ...
                .group(Group.of("context", "command.abuseprotection.context.description")
                        .subCommand(SubCommand.of("donor", "command.abuseprotection.context.donor.description")
                                ...
                                .argument(Argument.bool(
                                        "state", "command.abuseprotection.context.donor.options.state.description")))
                        .subCommand(SubCommand.of("receiver", "command.abuseprotection.context.receiver.description")
                                ...
                                .argument(Argument.bool(
                                        "state",
                                        "command.abuseprotection.context.receiver.options.state.description"))))
                .group(Group.of("cooldown", "command.abuseprotection.cooldown.description")
                        .subCommand(SubCommand.of("set", "command.abuseprotection.cooldown.set.description")
                                .handler(new SetCooldown(guildRepository))
                                .argument(Argument.integer(
                                                "minutes",
                                                "command.abuseprotection.cooldown.set.options.minutes.description")
                                        .min(0)
                                        .max(ChronoUnit.WEEKS.getDuration().toMinutes())
                                        .asRequired()))
                        ...
                        .subCommand(SubCommand.of("direction", "command.abuseprotection.cooldown.direction.description")
                                ...
                                .argument(Argument.text(
                                                "direction",
                                                "command.abuseprotection.cooldown.direction.options.direction.description")
                                        .asRequired()
                                        .withAutoComplete())))
                .group(Group.of("limit", "command.abuseprotection.limit.description")
                        .subCommand(SubCommand.of("donor", "command.abuseprotection.limit.donor.description")
                                ...
                                .argument(Argument.integer(
                                                "limit",
                                                "command.abuseprotection.limit.donor.options.limit.description")
                                        .min(0)
                                        .max(100_000))
                                .argument(Argument.integer(
                                                "hours",
                                                "command.abuseprotection.limit.donor.options.hours.description")
                                        .min(1)
                        ...
                        .subCommand(SubCommand.of("receiver", "command.abuseprotection.limit.receiver.description")
                                ...
                                .argument(Argument.integer(
                                                "limit",
                                                "command.abuseprotection.limit.receiver.options.limit.description")
                                        .min(0)
                                        .max(100_000))
                                .argument(Argument.integer(
                                                "hours",
                                                "command.abuseprotection.limit.receiver.options.hours.description")
                                        .min(1)
                                        .max(ChronoUnit.WEEKS.getDuration().toHours())))));
    }
}
