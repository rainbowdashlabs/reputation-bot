    ...
    public Slash slash() {
        return Slash.of("roles", "command.roles.description")
                ...
                .subCommand(SubCommand.of("add", "command.roles.add.description")
                        ...
                        .argument(Argument.role("role", "command.roles.add.options.role.description")
                                .asRequired())
                ...
                .subCommand(SubCommand.of("remove", "command.roles.remove.description")
                        ...
                        .argument(Argument.role("role", "command.roles.remove.options.role.description")
                                .asRequired()))
                .group(Group.of("receiver", "command.roles.receiver.description")
                        ...
                        .subCommand(SubCommand.of("remove", "command.roles.receiver.remove.description")
                                ...
                                .argument(
                                        Argument.role("role", "command.roles.receiver.remove.options.role.description")
                                                .asRequired())))
                ...
                .subCommand(SubCommand.of("refresh", "command.roles.refresh.description")
                        .handler(refresh))
                .subCommand(
                        SubCommand.of("list", "command.roles.list.description").handler(new List(guildRepository)))
