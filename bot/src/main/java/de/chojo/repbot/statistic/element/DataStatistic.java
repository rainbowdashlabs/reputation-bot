...
public class DataStatistic implements ReplacementProvider {
    ...
    public List<Replacement> replacements() {
        return List.of(
                Replacement.create("guild_count", guilds),
                Replacement.create("channel_count", channel),
                Replacement.create("active_guilds", activeGuilds),
                Replacement.create("active_channel", activeChannel),
                Replacement.create("total_rep", totalRep),
                Replacement.create("today_rep", todayRep),
                Replacement.create("weekly_rep", weeklyRep),
                Replacement.create("weekly_avg_rep", weeklyAvgRep));
    }
}
