...
public class SettingsPOJO {
    ...
    public SettingsPOJO(AbuseProtectionPOJO abuseProtection, AnnouncementsPOJO announcements, AutopostPOJO autopost, GeneralPOJO general, LogChannelPOJO logChannel, MessagesPOJO messages, ReputationPOJO reputation, ThankingPOJO thanking) {
    ...
    public static SettingsPOJO generate(Guild guild, GuildRepository guildRepository) {
        ...
        return new SettingsPOJO(settings.abuseProtection(), settings.announcements(),
                settings.autopost(), settings.general(), settings.logChannel(), settings.messages(), settings.reputation(), thankingPOJO);
    }
}
