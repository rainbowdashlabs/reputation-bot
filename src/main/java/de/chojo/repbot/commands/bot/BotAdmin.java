...
public class BotAdmin implements SlashProvider<Slash> {
    ...
    public BotAdmin(GuildRepository guildRepository, Configuration configuration, Statistic statistics, SessionService sessionService) {
        ...
        if (!SysVar.propOrEnv("docker", "DOCKER", "false").equals("true")) {
            groupBuilder.subCommand(SubCommand.of("restart", "Restart bot")
        ...
        groupBuilder.subCommand(SubCommand.of("status", "System status")
        ...
        slash = builder.group((GroupBuilder) groupBuilder)
                       ...
                       .group(group("system_message", "send a system message")
                               ...
                               .subCommand(sub("all", "Send a system message to all guilds")
                                       .handler(((event, context) -> event.reply("not implemented").complete()))))
                       .build();
    }
