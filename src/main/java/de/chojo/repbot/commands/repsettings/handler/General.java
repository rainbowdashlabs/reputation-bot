...
public class General implements SlashHandler {
    ...
    public void onSlashCommand(SlashCommandInteractionEvent event, EventContext context) {
        ...
        var settings = StringSelectMenu.create("settings")
                ...
                .addOption(
                        "command.repsettings.general.message.option.byreaction.name",
                        "reactions",
                        "command.repsettings.general.message.option.byreaction.description")
                .addOption(
                        "command.repsettings.general.message.option.byanswer.name",
                        "answers",
                        "command.repsettings.general.message.option.byanswer.description")
                .addOption(
                        "command.repsettings.general.message.option.bymention.name",
                        "mention",
                        "command.repsettings.general.message.option.bymention.description")
                .addOption(
                        "command.repsettings.general.message.option.byfuzzy.name",
                        "fuzzy",
                        "command.repsettings.general.message.option.byfuzzy.description")
                .addOption(
                        "command.repsettings.general.message.option.byembed.name",
                        "embed",
                ...
                .addOption(
                        ...
                        "reputationmode",
                        "command.repsettings.general.message.option.reputationmode.description")
                .build();
        var reactions = getMenu(
                "reactions",
                "command.repsettings.general.message.option.byreaction.description",
        ...
        var reputationMode = StringSelectMenu.create("reputationmode")
                ...
                .setRequiredRange(1, 1)
                .addOption(
                        ReputationMode.TOTAL.localeCode(),
                        ReputationMode.TOTAL.name(),
                        "command.repsettings.general.message.reputationMode.total")
                .addOption(
                        ReputationMode.ROLLING_MONTH.localeCode(),
                        ReputationMode.ROLLING_MONTH.name(),
                        "command.repsettings.general.message.reputationMode.rollingMonth")
                .addOption(
                        ReputationMode.ROLLING_WEEK.localeCode(),
                        ReputationMode.ROLLING_WEEK.name(),
                        "command.repsettings.general.message.reputationMode.rollingWeek")
                .addOption(
                        ReputationMode.WEEK.localeCode(),
                        ReputationMode.WEEK.name(),
                        "command.repsettings.general.message.reputationMode.week")
                .addOption(
                        ReputationMode.MONTH.localeCode(),
                        ReputationMode.MONTH.name(),
                        "command.repsettings.general.message.reputationMode.month")
                .setDefaultValues(Collections.singletonList(
                        guildSettings.general().reputationMode().name()))
                .build();
        ...
        context.registerMenu(MenuAction.forCallback(getSettings(context, guildSettings), event)
                ...
                .addComponent(MenuEntry.of(
                                reactions,
                                ctx -> refresh(
                                        ctx,
                                        res -> guildSettings.reputation().reactionActive(res),
                                        context,
                                        guildSettings))
                        .hidden())
                .addComponent(MenuEntry.of(
                                ...
                                ctx -> refresh(
                                        ctx,
                                        res -> guildSettings.reputation().answerActive(res),
                                        context,
                                        guildSettings))
                        .hidden())
                .addComponent(MenuEntry.of(
                                ...
                                ctx -> refresh(
                                        ctx,
                                        res -> guildSettings.reputation().mentionActive(res),
                                        context,
                                        guildSettings))
                        .hidden())
                .addComponent(MenuEntry.of(
                                ...
                                ctx -> refresh(
                                        ctx,
                                        res -> guildSettings.reputation().fuzzyActive(res),
                                        context,
                                        guildSettings))
                        .hidden())
                .addComponent(MenuEntry.of(
                                ...
                                ctx -> refresh(
                                        ctx,
                                        res -> guildSettings.reputation().embedActive(res),
                                        context,
                                        guildSettings))
                        .hidden())
                .addComponent(MenuEntry.of(
                                ...
                                ctx -> refresh(
                                        ...
                                        res -> {
                                            ...
                                            CompletableFuture.runAsync(() -> context.interactionHub()
                ...
                .addComponent(MenuEntry.of(
                                ...
                                ctx -> refresh(
                                        ctx,
                                        res -> guildSettings.reputation().directActive(res),
                                        context,
                                        guildSettings))
                        .hidden())
