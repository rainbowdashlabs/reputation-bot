        ...
        super(Slash.of("ranking", "command.ranking.description")
                ...
                .group(group("server", "command.ranking.server.description")
                        .subCommand(sub("received", "command.ranking.server.received.description")
                                .handler(new GuildReceived(guildRepository, configuration, false))
                                .argument(text("mode", "command.ranking.server.received.options.mode.description")
                                        .withAutoComplete()))
                        .subCommand(sub("given", "command.ranking.server.given.description")
                                .handler(new GuildGiven(guildRepository, configuration))
                                .argument(text("mode", "command.ranking.server.given.options.mode.description")
                                        .withAutoComplete())))
                .group(group("user", "command.ranking.user.description")
                        .subCommand(sub("received", "command.ranking.user.received.description")
                                .handler(new UserReceived(guildRepository, configuration))
                                .argument(text("mode", "command.ranking.user.received.options.mode.description")
                                        .withAutoComplete())
                        ...
                        .subCommand(sub("given", "command.ranking.user.given.description")
                                .handler(new UserGiven(guildRepository, configuration))
                                .argument(text("mode", "command.ranking.user.given.options.mode.description")
                                        .withAutoComplete())
