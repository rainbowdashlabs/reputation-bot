        ...
        return Slash.of("roles", "command.roles.description")
                ...
                .group(Group.of("receiver", "command.roles.receiver.description")
                        .subCommand(SubCommand.of("add", "command.roles.receiver.add.description")
                                ...
                                .argument(Argument.role("role", "command.roles.receiver.add.role.description")
                                                  .asRequired()))
                        .subCommand(SubCommand.of("remove", "command.roles.receiver.remove.description")
                                .handler(new RemoveReceiver(guilds))
                                .argument(Argument.role("role", "command.roles.receiver.remove.role.description")
                                                  .asRequired())))
                .group(Group.of("donor", "command.roles.donor.description")
                        .subCommand(SubCommand.of("adddonor", "command.roles.donor.add.description")
                                .handler(new AddDonor(guilds))
                                .argument(Argument.role("role", "command.roles.donor.add.role.description")
                                                  .asRequired()))
                        .subCommand(SubCommand.of("removedonor", "command.roles.donor.remove.description")
                                .handler(new RemoveDonor(guilds))
                                .argument(Argument.role("role", "command.roles.donor.remove.role.description")
                                                  .asRequired())))
