CREATE TABLE IF NOT EXISTS repbot_schema.settings_audit_log (
...
CREATE INDEX IF NOT EXISTS settings_audit_log_guild_id_member_id_index
    ON repbot_schema.settings_audit_log (guild_id, member_id);

CREATE INDEX IF NOT EXISTS settings_audit_log_guild_id_settings_identifier_index
...
CREATE TABLE IF NOT EXISTS repbot_schema.guild_session (
    guild_id  BIGINT                  NOT NULL,
    member_id BIGINT                  NOT NULL,
    token     TEXT                    NOT NULL
